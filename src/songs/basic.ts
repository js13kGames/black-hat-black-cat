//import { Player } from '../song-player/player-custom'
//import { Conductor } from '../song-player/conductor'
import Conductor from '../bandjs/band-js'
import equalTemperment from '../bandjs/equal-temperment'
import NoisesInstrumentPack from '../bandjs/noises-instrument'
import northAmericanRhythm from '../bandjs/north-american-rhythm'
import OscillatorInstrumentPack from '../bandjs/oscillatorsInstrument'

Conductor.loadPack('tuning', 'equalTemperament', equalTemperment)
Conductor.loadPack('rhythm', 'northAmerican', northAmericanRhythm)
Conductor.loadPack('instrument', 'oscillators', OscillatorInstrumentPack)
Conductor.loadPack('instrument', 'noises', NoisesInstrumentPack)

import Conductor from './band-js' // Changed to regular import to access static methods
/*import type {
  IGainNode,
...
export default class Instrument {
  ...
  constructor(name?: string, pack?: string, conductor?: Conductor) {
    if (!conductor) {
      throw new Error('Conductor instance is required to create an Instrument.')
    }
